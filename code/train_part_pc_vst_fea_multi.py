...
def train(conf):
    ...
    conf.exp_name = 'part_pc_ae_chair_3000_vst_fea_kl0.01_multi_2_parts_train'
    conf.category = 'Chair'
    ...
    if conf.load_model:
        decoder.load_state_dict(torch.load(f'/home/zhangxc/tmp/structurenet/data/models/part_pc_ae_chair_3000_vst_fea_kl0.01_multi_2/505_net_part_pc_decoder.pth'))
        encoder.load_state_dict(torch.load(f'/home/zhangxc/tmp/structurenet-master/data/models/part_pc_ae_chair_3000_vst_fea_kl0.01_multi_2_parts_img_encoder/76_net_img_encoder.pth'))
