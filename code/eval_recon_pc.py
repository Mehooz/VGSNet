...
dataset = PartNetDataset('/home/zhangxc/tmp/structurenet/data/partnetdata/chair_hier_3000', 'test_no_other_less_than_10_parts.txt', data_features, load_geo=True)
