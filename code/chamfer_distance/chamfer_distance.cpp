...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("forward_cuda", &chamfer_distance_forward_cuda, "ChamferDistance forward (CUDA:2)");
    m.def("backward", &chamfer_distance_backward, "ChamferDistance backward");
    m.def("backward_cuda", &chamfer_distance_backward_cuda, "ChamferDistance backward (CUDA:2)");
}
