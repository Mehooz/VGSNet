...
def add_base_args(parser):
    parser.add_argument('--exp_name', type=str, default='pc_ae_chair', help='name of the training run')
...
def add_model_args(parser):
    parser.add_argument('--model_path', type=str, default='/home/zhangxc/tmp/structurenet-master/data/models')
...
def add_train_vae_args(parser):
    ...
    parser.add_argument('--load_geo', action='store_true', default=True)
    ...
    parser.add_argument('--model_version', type=str, default='model_pc', help='model file name')
